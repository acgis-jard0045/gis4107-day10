...
def test_getFileContent():
    ...
    desc = "getFileContent Test:"
    expected = "Hey there, I'm a demo!"
    actual = FU.getFileContent(os.path.join(script_folder, "demo.txt"))
    print_test_results(FU.getFileContent, desc, expected, actual)

    desc = "getFileContent Test:"
    expected = "D:\\acgis\gis4107_Intro2Prog\day10\lab\demo2.txtdoes not exist"
    actual = FU.getFileContent(os.path.join(script_folder, "demo2.txt"))
    print_test_results(FU.getFileContent, desc, expected, actual)


def test_writeToFile():

    desc = "writeToFile Test:"
    expected = "text for test"
    actual = FU.writeToFile(os.path.join(script_folder, "writetoFileTest.txt"), "text for test")
