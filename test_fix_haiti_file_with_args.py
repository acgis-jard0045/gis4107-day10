...
import csv
import inspect
import fix_haiti_file_with_args as fh
reload(fh)
...
def test_process_file():
    ...
    ##
    file1 = open(os.path.join(script_folder, "Haiti_Admin_Names.csv"), 'r')
    file2 = open(os.path.join(script_folder, "Fixed_Haiti_Admin_Names.csv"), 'r')
